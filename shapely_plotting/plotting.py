...
# def plot_geoarray(array: numpy.array, transform: Affine = None, nodata: float = None, axis: pyplot.Axes = None, show: bool = False, **kwargs):
#     """
...
#
#     bounds = bounds_from_opposite_corners(origin, origin + numpy.flip(array.shape) * resolution)
...
#
#
# def plot_dataset(dataset: gdal.Dataset, index: int = 0, axis: pyplot.Axes = None, show: bool = False, **kwargs):
#     """
